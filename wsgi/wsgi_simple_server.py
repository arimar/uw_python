...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>winter_2012/week06/wsgi_simple_server.py at gh-pages from jon-jacky/uw_python - GitHub</title>
...
<meta content="6Z1OG9kQNhNnaq68hXFfaLYz5vpVWN50Xaimz8U3qsA=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-f18e47f6b8ff4e1edebdac2dc35b1ef0fb0eeae0.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/jon-jacky/uw_python/blob/e72c9bb215e312d9c23a9517967a33cd7cbdf1f2/winter_2012/week06/wsgi_simple_server.py'>
          ...
          <div class="context-body pane-selector commitish-selector js-filterable-commitishes">
            <div class="filterbar">
              ...
              <div class="commitish-item branch-commitish selector-item">
                <h4>
                    <a href="/jon-jacky/uw_python/blob/gh-pages/winter_2012/week06/wsgi_simple_server.py" data-name="gh-pages" rel="nofollow">gh-pages</a>
                </h4>
              </div>
              <div class="commitish-item branch-commitish selector-item">
                <h4>
                    <a href="/jon-jacky/uw_python/blob/master/winter_2012/week06/wsgi_simple_server.py" data-name="master" rel="nofollow">master</a>
                </h4>
              </div>
...
<!-- block_view_fragment_key: views4/v8/blob:v17:11bb5120ad90ee58ba81dee5b11ae6e0 -->
  <div id="slider">

    <div class="breadcrumb" data-path="winter_2012/week06/wsgi_simple_server.py/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/jon-jacky/uw_python/tree/e72c9bb215e312d9c23a9517967a33cd7cbdf1f2" class="js-rewrite-sha" itemprop="url"><span itemprop="title">uw_python</span></a></b> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/jon-jacky/uw_python/tree/e72c9bb215e312d9c23a9517967a33cd7cbdf1f2/winter_2012" class="js-rewrite-sha" itemscope="url"><span itemprop="title">winter_2012</span></a></span> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/jon-jacky/uw_python/tree/e72c9bb215e312d9c23a9517967a33cd7cbdf1f2/winter_2012/week06" class="js-rewrite-sha" itemscope="url"><span itemprop="title">week06</span></a></span> / wsgi_simple_server.py <span class="js-clippy clippy-button " data-clipboard-text="winter_2012/week06/wsgi_simple_server.py" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>

    <div class="frames">
      <div class="frame frame-center" data-path="winter_2012/week06/wsgi_simple_server.py/" data-permalink-url="/jon-jacky/uw_python/blob/e72c9bb215e312d9c23a9517967a33cd7cbdf1f2/winter_2012/week06/wsgi_simple_server.py" data-title="winter_2012/week06/wsgi_simple_server.py at gh-pages from jon-jacky/uw_python - GitHub" data-type="blob">
          <ul class="big-actions">
            <li><a class="file-edit-link minibutton js-rewrite-sha" href="/jon-jacky/uw_python/edit/e72c9bb215e312d9c23a9517967a33cd7cbdf1f2/winter_2012/week06/wsgi_simple_server.py" data-method="post" rel="nofollow"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files" class="bubble">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/jon-jacky/uw_python/raw/gh-pages/winter_2012/week06/wsgi_simple_server.py" id="raw-url">raw</a></li>
                  <li><a href="/jon-jacky/uw_python/blame/gh-pages/winter_2012/week06/wsgi_simple_server.py">blame</a></li>
                <li><a href="/jon-jacky/uw_python/commits/gh-pages/winter_2012/week06/wsgi_simple_server.py" rel="nofollow">history</a></li>
              </ul>
            </div>
...
<span id="L32" rel="#L32">32</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="sd">&quot;&quot;&quot;</span></div><div class='line' id='LC2'><span class="sd">Simple WSGI application runner, including its own WSGI server</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="sd">Usage: python simple_wsgi_server.py &lt;application&gt; &lt;port&gt;</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'><span class="sd">Example: python simple_wsgi_server.py test.wsgi 8080</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'><span class="sd">Default application is wsgi_test, default port is 8000</span></div><div class='line' id='LC9'><br/></div><div class='line' id='LC10'><span class="sd">The application module can be named anything, but the </span></div><div class='line' id='LC11'><span class="sd">application callable it provides MUST be named &#39;application&#39;</span></div><div class='line' id='LC12'><span class="sd">&quot;&quot;&quot;</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'><span class="kn">import</span> <span class="nn">sys</span></div><div class='line' id='LC15'><span class="kn">from</span> <span class="nn">wsgiref.simple_server</span> <span class="kn">import</span> <span class="n">make_server</span></div><div class='line' id='LC16'><br/></div><div class='line' id='LC17'><span class="n">appname</span> <span class="o">=</span> <span class="s">&#39;wsgi_test&#39;</span></div><div class='line' id='LC18'><span class="n">port</span> <span class="o">=</span> <span class="mi">8000</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'><br/></div><div class='line' id='LC21'><span class="n">nargs</span> <span class="o">=</span> <span class="nb">len</span><span class="p">(</span><span class="n">sys</span><span class="o">.</span><span class="n">argv</span><span class="p">)</span></div><div class='line' id='LC22'><span class="k">if</span> <span class="n">nargs</span> <span class="o">&gt;</span> <span class="mi">1</span><span class="p">:</span></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">appname</span> <span class="o">=</span> <span class="n">sys</span><span class="o">.</span><span class="n">argv</span><span class="p">[</span><span class="mi">1</span><span class="p">]</span></div><div class='line' id='LC24'><span class="k">if</span> <span class="n">nargs</span> <span class="o">&gt;</span> <span class="mi">2</span><span class="p">:</span></div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">port</span> <span class="o">=</span> <span class="nb">int</span><span class="p">(</span><span class="n">sys</span><span class="o">.</span><span class="n">argv</span><span class="p">[</span><span class="mi">2</span><span class="p">])</span></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'><span class="n">app</span> <span class="o">=</span> <span class="nb">__import__</span><span class="p">(</span><span class="n">appname</span><span class="p">)</span></div><div class='line' id='LC28'><span class="n">httpd</span> <span class="o">=</span> <span class="n">make_server</span><span class="p">(</span><span class="s">&#39;&#39;</span><span class="p">,</span> <span class="n">port</span><span class="p">,</span> <span class="n">app</span><span class="o">.</span><span class="n">application</span><span class="p">)</span></div><div class='line' id='LC29'><span class="k">print</span> <span class="s">&quot;Running </span><span class="si">%s</span><span class="s"> on port </span><span class="si">%s</span><span class="s"> ...&quot;</span> <span class="o">%</span> <span class="p">(</span><span class="n">appname</span><span class="p">,</span> <span class="n">port</span><span class="p">)</span></div><div class='line' id='LC30'><br/></div><div class='line' id='LC31'><span class="c"># Respond to requests until process is killed</span></div><div class='line' id='LC32'><span class="n">httpd</span><span class="o">.</span><span class="n">serve_forever</span><span class="p">()</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span title="0.11571s from fe9.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.11796' data-host='fe9'></span>
  </body>
</html>
